# GitHub Deployment Helper Script for Voltrend

Write-Host "Voltrend GitHub Deployment Helper" -ForegroundColor Cyan
...
Write-Host ""
$repoUrl = Read-Host "Enter your new GitHub Repository URL (e.g., https://github.com/username/voltrend.git)"
